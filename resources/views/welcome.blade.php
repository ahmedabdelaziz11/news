            ...
            <div class="row">
                <div class="col-md-6 tn-left">
                    <div class="row tn-slider">
                        ...
                        <div class="col-md-6">
                            <div class="tn-img">
                                <img src="{{URL::asset('assets/img/news-450x350-2.jpg')}}" />
                                <div class="tn-title">
                ...
                <div class="col-md-6 tn-right">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="tn-img">
                                <img src="{{URL::asset('assets/img/news-350x223-1.jpg')}}" />
                                <div class="tn-title">
                        ...
                        <div class="col-md-6">
                            <div class="tn-img">
                                <img src="{{URL::asset('assets/img/news-350x223-2.jpg')}}" />
                                <div class="tn-title">
                                    <a href="">Lorem ipsum dolor sit</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="tn-img">
                                <img src="{{URL::asset('assets/img/news-350x223-3.jpg')}}" />
                                <div class="tn-title">
                                    <a href="">Lorem ipsum dolor sit</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="tn-img">
                                <img src="{{URL::asset('assets/img/news-350x223-4.jpg')}}" />
                                <div class="tn-title">
                                    <a href="">Lorem ipsum dolor sit</a>
                                </div>
                            </div>
